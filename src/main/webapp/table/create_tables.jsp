...
try
{
	...
	String q1="create table userszero(name varchar(100),email varchar(100)primary key,mobileNumber bigint,securityQuestion varchar(200),answer varchar(200),password varchar(100),address varchar(500),city varchar(100),state varchar(100),country varchar(100))";
	...
	String q5="create table productone(id int,image  BLOB,name varchar(500),category varchar(200),price int,active varchar(10))";
