...
<h3 class="form-heading">Select Your New Securtiy Question</h3>
 ...
 <hr>
 <h3 class="form-heading">Enter Your New Answer</h3>
 <input class="input-style" type="text" name="newAnswer" placeholder="Enter Your New Answer" required>
<hr>
<h3 class="form-heading">Enter Password (For Security)</h3>
